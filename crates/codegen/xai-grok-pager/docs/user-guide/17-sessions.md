...
See [Anthropic Provider](25-anthropic-provider.md#6-claude-agent-cli-experimental-subscription-mode)
and [Migration](26-anthropic-migration.md#sessions-and-execution-modes).
...
- Shell version
- Auth method (OAuth vs API key) and where to manage account and credits (https://grok.com/?_s=billing for OAuth, console.x.ai for API key; API-key sessions also suggest connecting xAI in `/providers` for SuperGrok)
- Session ID
- Working directory
