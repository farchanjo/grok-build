...
use super::settings::setters::{
    ...
    set_keep_text_selection, set_max_thoughts_width, set_media_auto_enrich,
    set_media_compaction_enrichment, set_media_max_aux_tokens_per_call, set_media_max_media_bytes,
    set_media_max_output_chars, set_media_preflight_policy, set_media_routes,
    set_media_understanding_enabled, set_media_unknown_policy, set_multiline_mode,
    ...
    set_timestamps, set_vim_mode, set_voice_capture_mode, set_voice_stt_language, test_media_route,
};
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        // Media-understanding settings actions.
        Action::SetMediaUnderstandingEnabled(v) => set_media_understanding_enabled(app, v),
        Action::SetMediaAutoEnrich(v) => set_media_auto_enrich(app, v),
        Action::SetMediaCompactionEnrichment(v) => set_media_compaction_enrichment(app, v),
        Action::SetMediaUnknownPolicy(v) => set_media_unknown_policy(app, v),
        Action::SetMediaPreflightPolicy(v) => set_media_preflight_policy(app, v),
        Action::SetMediaMaxOutputChars(v) => set_media_max_output_chars(app, v),
        Action::SetMediaMaxAuxTokensPerCall(v) => set_media_max_aux_tokens_per_call(app, v),
        Action::SetMediaMaxMediaBytes(v) => set_media_max_media_bytes(app, v),
        Action::SetMediaRoutes { category, routes } => set_media_routes(app, category, routes),
        Action::TestMediaRoute {
            category,
            index,
            path,
        } => test_media_route(app, category, index, path),
