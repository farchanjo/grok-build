...
use super::settings::setters::{
    ...
    clear_fork_secondary_model, clear_media_audio_model, clear_media_file_model,
    clear_media_image_model, clear_media_video_model, preview_auto_dark_theme,
    preview_auto_light_theme, preview_theme, set_artifact_language,
    ...
    set_compaction_band_count, set_compaction_fallback_model, set_compaction_jev_enabled,
    set_compaction_primary_model, set_compaction_strategy, set_compaction_trigger_policy,
    ...
    set_contextual_hint_word_select, set_control, set_conversation_language, set_default_model,
    set_default_selected_permission, set_display_refresh_auto_cadence, set_fork_secondary_model,
    set_group_tool_verbs, set_hunk_tracker_mode, set_invert_scroll, set_jev_transport,
    set_keep_text_selection, set_max_thoughts_width, set_media_audio_model, set_media_file_model,
    set_media_image_model, set_media_routing, set_media_video_model, set_multiline_mode,
    set_page_flip_on_send, set_prompt_suggestions, set_remember_tool_approvals, set_render_mermaid,
    set_repetition_guard, set_respect_manual_folds, set_screen_mode, set_scroll_lines,
    set_scroll_mode, set_scroll_speed, set_session_subagent_model, set_session_tersify_level,
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::SetConversationLanguage(s) => set_conversation_language(app, s),
        Action::SetArtifactLanguage(s) => set_artifact_language(app, s),
        ...
        Action::SetCompactionJevEnabled(v) => set_compaction_jev_enabled(app, v),
        Action::SetJevTransport(v) => set_jev_transport(app, v),
        Action::SetControl(key, value) => set_control(app, key, value),
        // Media settings actions.
        Action::SetMediaRouting(v) => set_media_routing(app, v),
        Action::SetMediaImageModel(v) => set_media_image_model(app, v),
        Action::ClearMediaImageModel => clear_media_image_model(app),
        Action::SetMediaAudioModel(v) => set_media_audio_model(app, v),
        Action::ClearMediaAudioModel => clear_media_audio_model(app),
        Action::SetMediaVideoModel(v) => set_media_video_model(app, v),
        Action::ClearMediaVideoModel => clear_media_video_model(app),
        Action::SetMediaFileModel(v) => set_media_file_model(app, v),
        Action::ClearMediaFileModel => clear_media_file_model(app),
