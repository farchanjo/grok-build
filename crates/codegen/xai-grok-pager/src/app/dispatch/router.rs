...
use super::settings::setters::{
    ...
    set_contextual_hint_word_select, set_conversation_language, set_default_model,
    ...
    set_max_thoughts_width, set_media_audio_model, set_media_file_model, set_media_image_model,
    set_media_routing, set_media_video_model, set_multiline_mode, set_page_flip_on_send,
    set_prompt_suggestions, set_remember_tool_approvals, set_render_mermaid, set_repetition_guard,
