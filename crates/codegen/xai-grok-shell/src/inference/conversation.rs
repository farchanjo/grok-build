...
//!
//! The canonical types now live in `xai_grok_inference_types::conversation`.
...
pub use xai_grok_inference_types::conversation::*;
...
// via `Box::new(trace)`.
//
// Tests for conversation types now live in xai-grok-inference-types crate.
