...
use crate::agent::subagent::assigned_spawn::AssignedSpawnSender;
...
pub(crate) struct WorkflowManager {
    ...
    >,
    assigned_spawn_sender: Option<AssignedSpawnSender>,
    ...
    pub(crate) fn launch(
        ...
        let (host_service, host_drained) = spawn_workflow_host_service(
            WorkflowHostParams {
                ...
                assigned_spawn_sender: self.assigned_spawn_sender.clone(),
